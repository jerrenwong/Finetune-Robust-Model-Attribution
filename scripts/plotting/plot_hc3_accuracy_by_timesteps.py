...
def main():
    ...
    # Professional NeurIPS-style color scheme (muted, professional colors)
    # Using a cohesive palette: deep blue, deep purple/magenta, and warm orange
    colors = {
        'bert': '#2E86AB',      # Deep blue
        'qwen': '#A23B72',      # Deep purple/magenta
        'llama': '#F18F01'      # Warm orange
    }
